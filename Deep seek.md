...
```mermaid
flowchart TD
    A[Législation US<br>e.g. Commodity Exchange Act] --> B[Régulateurs<br>CFTC, SEC, NFA]
    B -- Supervision & Agrément --> C[CME Group<br>DCM & DCO]
    
    C -- Création des marchés --> D[Sous-Marchés/<br>Filiales]
    D --> D1[COMEX<br>Métaux: Or & Argent]
    D --> D2[CME<br>Forex & Cryptos]
    
    D1 & D2 -- Liste les produits --> E[Produits Dérivés<br>Futures & Options]
    E --> F1[Or & Argent<br>Livraison Physique]
    E --> F2[Forex Majeurs<br>Livraison Physique ou Cash]
    E --> F3[Bitcoin & Ether<br>Règlement Cash]
    
    F1 & F2 & F3 -- Négociation --> G[Plateforme de Trading<br>CME Globex]
    
    H[Participants<br>Institutionnels & Retail<br>via Courtiers] -- Passe ordres --> G
    G -- Transmission --> I[Chambre de Compensation<br>CME Clearing]
    I -- Compensation & Garantie --> J[Règlement Final<br>Cash ou Livraison]
```
